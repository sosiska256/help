...
int text(int a) {
        ...
        if(What =="N")
            asd = 3;
        switch (asd) {
            case 0:cout<<"Пояснения величин смотри выше"<< endl;
                cout<<"K = ";
                cin>> K;
                cout<<"i = ";
                cin>> i;
                cout<<"I = " << K * i<<"бит"<<endl;
                break;
            case 1:cout<<"Пояснения величин смотри выше"<< endl;
                cout<<"I = ";
                cin>> I;
                cout<<"i = ";
                cin>> i;
                cout<<"K = " << I / i<<"бит"<<endl;
                break;
            case 2:cout<<"Пояснения величин смотри выше"<< endl;
                cout<<"N = ";
                cin>> N;
                if (N == 0) {
                    cout<<"I = ";
                    ...
                    cout<<"i =" << log(N)<<"бит"<<endl;
                    break;
                }
            case 3:
            cout<<"Пояснения величин смотри выше"<< endl;
                cout<<"i = ";
                cin>>i;
                cout<<"N = " << pow(2, i);
                break;
        ...
        cout<<"Брат, лень считать в другие системы счисления поэтому результат в битах"<< endl;
        cout<<"Eсли нужно в байтах, тогда тогда дели результат на 8, в килобайтах дели 8 и 1024Б дальше мне пофиг это гг";
        a = 1;
        return a;
    }
    int photo(int a) {
        ...
        switch (asd) {
            ...
            case 2:cout<<"Пояснения величин смотри выше"<< endl;
                ...
                cout<<"M = " << V / (I * t * k);
                break;
            case 3:cout<<"Пояснения величин смотри выше"<< endl;
                cout<<"V = ";
                cin>>V;
                cout<<"M = ";
                cin>>M;
                ...
                cout<<"t = " << V / (I * M * k);
                break;
            case 4:cout<<"Пояснения величин смотри выше"<< endl;
                cout<<"V = ";
                cin>>V;
                cout<<"M = ";
                cin>>M;
